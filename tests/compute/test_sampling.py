...
def test_sample_neighbors_exclude_edges_heteroG(dtype):
    ...
    nd_b_idx = np.random.randint(low=1, high=14, dtype=dtype)
    nd_e_idx = np.random.randint(low=15, high=29, dtype=dtype)
    dig_b_idx = np.random.randint(low=1, high=14, dtype=dtype)
    dig_e_idx = np.random.randint(low=15, high=29, dtype=dtype)
    ...
    nd_b_idx = np.random.randint(low=1, high=14, dtype=dtype)
    nd_e_idx = np.random.randint(low=15, high=29, dtype=dtype)
    dtd_b_idx = np.random.randint(low=1, high=14, dtype=dtype)
    dtd_e_idx = np.random.randint(low=15, high=29, dtype=dtype)
